...
<div class="container p-4 my-2">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Product Name" aria-label="Username" id="product_name" name="name" value="{{ $product->name }}">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="128GB" name="storage" aria-label="Username" value="{{ $product->storage }}">
            <span class="input-group-text">Color</span>

            <!-- Product Color -->
            <input type="text" class="form-control" name="color" placeholder="black" aria-label="Server" value="{{ $product->color }}">
        </div>
        ...
        <div class="input-group">
            <button type="submit" id="update" class="btn btn-info w-100 mt-3">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
